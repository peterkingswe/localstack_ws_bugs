...
export const wsApiUrlWorksInAws = pulumi.all([wsApiGw.apiEndpoint, wsApiGwStage.name]).apply(v => v.join("/"))
export const wsApiUrlDoesntWorkInAwsButWorksInLs = wsApiGw.apiEndpoint;
